...
def generate_text(prompt, mac, embed, tokenizer, device='mps', max_new_tokens=50, temperature=0.9, top_p=0.9, repetition_penalty=1.3):
    mac.eval()
...
def run_tests(mac, embed, tokenizer, device='mps'):
    ...
    for prompt in test_prompts:
        generated = generate_text(
            ...
            temperature=0.8,
            top_p=0.85,
            repetition_penalty=1.8  # increased from 1.3
        )
...
if __name__ == "__main__":
    ...
    run_tests(mac, embed, tokenizer, device=device)